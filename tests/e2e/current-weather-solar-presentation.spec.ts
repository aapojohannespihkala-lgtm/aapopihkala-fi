...
const weatherFixture = {
  ...
  hourly: {
    time: Array.from(
      { length: 12 },
      (_, index) => `2026-09-08T${String(index + 20).padStart(2, '0')}:00`
    ),
    temperature_2m: Array.from({ length: 12 }, () => 16),
    precipitation_probability: Array.from({ length: 12 }, () => 40),
    weather_code: Array.from({ length: 12 }, () => 3),
    is_day: Array.from({ length: 12 }, (_, index) => (index === 0 ? 1 : 0)),
  },
  daily: {
    time: [
      '2026-09-08',
    ...
    precipitation_probability_max: [91, 88, 83, 76, 65, 45],
    sunrise: [
      '2026-09-08T06:32',
      '2026-09-09T06:35',
      '2026-09-10T06:38',
