...
GitHub Actionsin Build check ja Cloudflaren tuotantodeploy ovat eri vaiheita. CI tarkistaa repomuutoksen ja Cloudflare julkaisee tuotantoversion oman Workers Builds -integraationsa mukaisesti. Current2:n erillinen live-data-smoke käynnistyy `main`-päivityksestä ja retryttää julkaistua API:a deploy-viiveen yli, eikä se korvaa Cloudflaren deploy-mekanismia.
