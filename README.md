...
Tämä osio toimii projektin ajantasaisena työlistana. Se tarkistetaan ja päivitetään samassa PR:ssä aina, kun jokin alla oleva työ valmistuu, muuttuu olennaisesti tai uusi merkittävä jatkokehitystarve tunnistetaan. Valmistunut kohta poistetaan tai merkitään selvästi tehdyksi, jotta README ei säilytä vanhentunutta backlogia.
...
Nykyisiä parannuksia ovat muun muassa skip navigation, vähimmäiskokoiset interaktiiviset kohteet, reduced motion -tuki ja regressiotestit. Jäljellä oleva audit kattaa ainakin:
